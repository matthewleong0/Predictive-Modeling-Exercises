...
After running some code really quickly, we can see that the guru lost about 2.72% of the data which is honestly an acceptable amount. However, there is a key issue with this analysis in general. He assumes a causal relationship or strong positive correlation between rent and green rating without considering any other variables that could affect the two. Fundamentally, the analysis done on the split between green certifications and non green certifications is based on this incorrect assumption.  
